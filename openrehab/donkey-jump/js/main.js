(function() {
    ...
    function loadImageResources(number) {
        my.DOM.get('progressText').innerHTML = 'load images...(' + ~~(number / imageResources.length * 100) + '%)';
    ...
    function loadAudioResources(number) {
        ...
        buzzGroup.bind('loadeddata', function(e) {
            my.DOM.get('progressText').innerHTML = 'load bgm...(' + ~~(number / len * 100) + '%)';
